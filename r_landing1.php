        ...
        <article>
            ...
            />
                <div class="profile-1">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Est magni voluptates soluta minima a cum temporibus quibusdam minus facilis architecto, repellendus offi
                    </p>
                </div>
                <br>
                                ...
                                <form id='eventEdit'>
                                    <div class='in-content12'>
                                        ...
                                        <div class='in-content-212'>
                                            ...
                                            <textarea type='text' id='event_description' name='event_description'></textarea>
                                ...
                                <form id='gigEdit'>
                                    <div class='in-content1'>
                                        ...
                                        <div class='in-content-21'>
                                            ...
                                            <h3>Change Caption</h3>
                                            <textarea type='text' id='gig_description' name='craft_description'></textarea>
                                            <br>
                                            ...
                                            <br>
                                            <button type='button' id='gig_delete' onclick='craftDelete()'>Delete</button>
                                        </div>
                                    </div>
                                    </div>
                                </form>
